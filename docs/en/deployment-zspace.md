...
See [Auto-update guide](deployment-autoupdate.md). `docker compose pull && up -d` from the project, or pin a tag (`mibeenvr:0.13.0`) for rollback. Data under your mapped path persists across recreation.
