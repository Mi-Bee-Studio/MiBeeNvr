...
func TestMergeLineage_RecordedAndRebound(t *testing.T) {
	...
	bucket1 := &model.Recording{
		ID: "bucket-1", CameraID: "cam1", FilePath: "/x/b1.mp4", Format: model.FormatH264,
	...
	bucket2 := &model.Recording{
		ID: "bucket-2", CameraID: "cam1", FilePath: "/x/b2.mp4", Format: model.FormatH264,
		StartedAt: now, EndedAt: now.Add(2 * time.Minute), Duration: 120, FileSize: 2, MergeStatus: model.MergeStatusMerged,
	}
...
func TestRollingReplaceLineage(t *testing.T) {
	...
	bucket := &model.Recording{
		ID: "rb-1", CameraID: "cam1", FilePath: "/x/rb.mp4", Format: model.FormatH264,
	...
	bucket2 := &model.Recording{
		ID: "rb-1", CameraID: "cam1", FilePath: "/x/rb2.mp4", Format: model.FormatH264,
